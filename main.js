...
console.log(
  'Пустая строка равна нулю, так как операнды разных типов преобразуются оператором == к числу. Таким образом пустая строка становятся нулём и равна нулю. А также опреатор == не проверяет типы операндов, проверяет только их значения.'
);
console.log('-----------------------');
